...
function mostrarTabla($usuarios, $total_paginas, $pagina_actual){
    ...
    echo "<ul>";
    echo    "<li class='sigan'>";
    echo        "<a onclick=\"mostrarXML('Controlador/tablasAdministrativos.php?index=". $mostrarAnterior . "')\">Anterior</a>";
    echo    "</li>";
    echo    "<li class='seleccion'>";
    echo "<select name='cat' id='cat' onchange=\"var option=document.getElementById('cat').value;mostrarXML('Controlador/tablasAdministrativos.php?index='+option);\">";
  ...
  echo    "</li>";
  echo    "<li class='sigan'>";
  echo        "<a onclick=\"mostrarXML('Controlador/tablasAdministrativos.php?index=". ($mostrarSiguiente) . "')\">Siguiente</a>";
  echo    "</li>";
  echo"</ul>";
  echo"</div>";
}
